...
def upgrade() -> None:
    ...
    conn.execute(sa.text(random_func_create))
    ...
    op.create_table(
        ...
        sa.Column(
            "closing_price",
            sa.Float(),
            server_default=sa.text("random_between(20,40)"),
            nullable=True,
        ...
        sa.Column(
            "assigning_price",
            sa.Float(),
            server_default=sa.text("random_between(10,20)"),
            nullable=True,
            comment="Price of closing of this task",
        ),
...
def downgrade() -> None:
    ...
    op.drop_table("task")
    op.drop_table("user")
    conn.execute(sa.text(random_func_delete))
